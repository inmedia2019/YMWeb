...
using YMWeb.Service.CommonService;
...
namespace YMWeb.Service.FlowManage
{
    ...
    public class FlowinstanceService : DataFilterService<FlowinstanceEntity>, IDenpendency
    {
        ...
        private string cacheKey = "YMWeb_flowinstancedata_";
        ...
        public async Task CreateInstance(FlowinstanceEntity entity)
        {
            ...
            if (entity.F_FrmType == 1)
            {
                ...
                var t = referencedAssemblies
                    .SelectMany(a => a.GetTypes().Where(t => t.FullName.Contains("YMWeb.Service.") && t.FullName.Contains("."+entity.F_DbName + "Service"))).FirstOrDefault();
