...
namespace YMWeb.Service.ContentManage
{
    ...
    public class ArticleNewsService : DataFilterService<ArticleNewsEntity>, IDenpendency
    {
        ...
        private string cacheKey = "YMWeb_cms_articlenewsdata_";
        ...
        public async Task SubmitForm(ArticleNewsEntity entity, string keyValue)
        {
            ...
            {
                entity.F_Zhaiyao = YMWeb.Code.TextHelper.GetSubString(YMWeb.Code.WebHelper.NoHtml(entity.F_Description),255);
            }
