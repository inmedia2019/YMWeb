...
namespace YMWeb.Service.ContentManage
{
    ...
    /// 描 述：标签管理服务类
    /// </summary>
    public class ContentLableService : DataFilterService<ContentLableEntity>, IDenpendency
    {
        private string cacheKey = "YMWeb_contentlabledata_";
        private string className = System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.FullName.Split('.')[3];
        public ContentLableService(IDbContext context) : base(context)
        {
        }
        #region 获取数据
        public async Task<List<ContentLableEntity>> GetList(string keyword = "")
        {
        ...
        public async Task<List<ContentLableEntity>> GetListByIds(string ids = "")
        {
            ...
            string sql = "select * from cms_contentlable where F_DeleteMark=false";
            if (searchIds.Length > 0)
        ...
        public async Task<ContentLableEntity> GetInfoById(string id)
        {
            ContentLableEntity query = null;
        ...
        public async Task<List<ContentLableEntity>> GetLookList(string keyword = "")
        {
            var list = new List<ContentLableEntity>();
        ...
        public async Task<List<ContentLableEntity>> GetLookList(SoulPage<ContentLableEntity> pagination, string keyword = "")
        {
            //获取数据权限
        ...
        public async Task<ContentLableEntity> GetForm(string keyValue)
        {
        ...
        public async Task<ContentLableEntity> GetLookForm(string keyValue)
        {
            var cachedata = await repository.CheckCache(cacheKey, keyValue);
        ...
        #region 提交数据
        public async Task SubmitForm(ContentLableEntity entity, string keyValue)
        {
            var datastr = "";
