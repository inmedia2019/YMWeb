...
namespace YMWeb.Web.Areas.InfoManage.Controllers
{
    ...
    public class FavitorinfoController :  ControllerBase
    {
        ...
        public FavitorinfoService _service {get;set;}

        #region 获取数据
        [HttpGet]
        [HandlerAjaxOnly]
        public async Task<ActionResult> GetGridJson(SoulPage<FavitorinfoEntity> pagination, string keyword)
        {
        ...
        public async Task<ActionResult> SubmitForm(FavitorinfoEntity entity, string keyValue)
        {
           FavitorinfoEntity data = null;
