...
namespace YMWeb.Web.Areas.InfoManage.Controllers
{
    ...
    public class CommentdzinfoController :  ControllerBase
    {
        ...
        public CommentdzinfoService _service {get;set;}

        #region 获取数据
        [HttpGet]
        [HandlerAjaxOnly]
        public async Task<ActionResult> GetGridJson(SoulPage<CommentdzinfoEntity> pagination, string keyword)
        {
        ...
        public async Task<ActionResult> SubmitForm(CommentdzinfoEntity entity, string keyValue)
        {
           CommentdzinfoEntity data = null;
