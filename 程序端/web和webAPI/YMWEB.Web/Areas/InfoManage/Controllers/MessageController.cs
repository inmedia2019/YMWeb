    ...
    public class MessageController :  ControllerBase
    {
        ...
        public async Task<ActionResult> SubmitForm(MessageEntity entity)
        {
            try
            {
                ...
                return await Success("操作成功。", className, entity, entity,"");
            }
            catch (Exception ex)
            {
                return await Error(ex.Message, className, entity, entity, "");
            }
        }
        [HttpPost]
        [HandlerAjaxOnly]
        ...
        public async Task<ActionResult> ReadAllMsgForm(int type=0)
        {
            ...
            try
            {
                ...
                return await Success("操作成功。", className, data, data, "");
            }
            catch (Exception ex)
            {
                return await Error(ex.Message, className, data, data, "");
            }
        }
        [HttpPost]
        [HandlerAjaxOnly]
