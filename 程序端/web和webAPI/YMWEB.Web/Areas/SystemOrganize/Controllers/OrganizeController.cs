    ...
    public class OrganizeController : ControllerBase
    {
        ...
        public async Task<ActionResult> SubmitForm(OrganizeEntity organizeEntity, string keyValue)
        {
            ...
            try
            {
                ...
                return await Success("操作成功。", className, organizeEntity, data, keyValue);
            }
            catch (Exception ex)
            {
                return await Error(ex.Message, className, organizeEntity, data, keyValue);
            }
        }
        [HttpPost]
        [HandlerAjaxOnly]
