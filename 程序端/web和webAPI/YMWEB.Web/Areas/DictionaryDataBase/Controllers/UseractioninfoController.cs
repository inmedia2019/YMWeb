...
namespace YMWeb.Web.Areas.DictionaryDataBase.Controllers
{
    ...
    public class UseractioninfoController :  ControllerBase
    {
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public async Task<ActionResult> GetGridJson(SoulPage<UseractioninfoEntity> pagination, string keyword)
        {
        ...
        public async Task<ActionResult> SubmitForm(UseractioninfoEntity entity, string keyValue)
        {
           UseractioninfoEntity data = null;
