...
namespace YMWeb.Web.Areas.DictionaryDataBase.Controllers
{
    ...
    public class CityInfoController :  ControllerBase
    {
        ...
        public CityInfoService _service {get;set; }
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public async Task<ActionResult> GetGridJson(SoulPage<CityInfoEntity> pagination, string keyword)
        {
            ...
            foreach (CityInfoEntity h in data)
            {
        ...
        public async Task<ActionResult> GetTreeSelectJson()
        {
            ...
            foreach (var item in data)
            {
                ...
                treeModel.text = item.F_CityName;
        ...
        public async Task<ActionResult> SubmitForm(CityInfoEntity entity, string keyValue)
        {
            CityInfoEntity data = null;
            ...
            try
            {
                ...
                //if (!string.IsNullOrEmpty(keyValue))
                //{
                //    if (data.F_CityName != entity.F_CityName)
                //    {
