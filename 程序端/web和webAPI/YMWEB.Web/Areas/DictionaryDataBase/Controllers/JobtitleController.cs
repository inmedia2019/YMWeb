...
namespace YMWeb.Web.Areas.DictionaryDataBase.Controllers
{
    ...
    public class JobtitleController :  ControllerBase
    {
        ...
        public JobtitleService _service {get;set;}

        #region 获取数据
        [HttpGet]
        [HandlerAjaxOnly]
        public async Task<ActionResult> GetGridJson(SoulPage<JobtitleEntity> pagination, string keyword)
        {
        ...
        public async Task<ActionResult> SubmitForm(JobtitleEntity entity, string keyValue)
        {
           JobtitleEntity data = null;
