...
namespace YMWeb.Web.Areas.DictionaryDataBase.Controllers
{
    ...
    public class PhonecodeController :  ControllerBase
    {
        ...
        public PhonecodeService _service {get;set;}

        #region 获取数据
        [HttpGet]
        [HandlerAjaxOnly]
        public async Task<ActionResult> GetGridJson(SoulPage<PhonecodeEntity> pagination, string keyword)
        {
        ...
        public async Task<ActionResult> SubmitForm(PhonecodeEntity entity, string keyValue)
        {
           PhonecodeEntity data = null;
