#pragma checksum "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c7fe0577d93325832c4350a5e2f1accd75959304"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_ContentManage_Views_Content_Index), @"mvc.1.0.view", @"/Areas/ContentManage/Views/Content/Index.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c7fe0577d93325832c4350a5e2f1accd75959304", @"/Areas/ContentManage/Views/Content/Index.cshtml")]
    public class Areas_ContentManage_Views_Content_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 1 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
...
<script>
    layui.use(['jquery', 'form', 'table', 'common', 'soulTable', 'dtree', 'commonTable', 'optimizeSelectOption'], function () {
        ...
        var DemoTree = dtree.render({
            ...
            icon: [""0"", ""-1""],  // 显示非最后一");
            WriteLiteral("级节点图标，隐藏最后一级节点图标\r\n            url: \"");
#nullable restore
#line 35 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
              Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Channel/GetTreeGridJson?v="" + new Date().Format(""yyyy-MM-dd hh:mm:ss"") // 使用url加载（可与data加载同时存在）
        });
         var treeid = """";
        ...
        // 绑定节点点击
         ...
         var ins=commonTable.rendertable({
             ...
             url: '");
#nullable restore
#line 58 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
               Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Content/GetGridJson',
             where: {
                 itemId: """",
                 keyword: """",
             },
             cols: [[
                 ...
                 //{
                 //    field: 'F_Ta");
            WriteLiteral(@"gs', title: '内容标签', width: 120, sort: true
                 ...
                 { field: 'F_CommentCount', title: '评论数', width: 100, sort: true },
                 {
                     ...
                     templet: function (d) {
      ");
            WriteLiteral(@"                   if (d.F_CreatorTime) {
                 ...
                 },
                 {
                     field: 'F_EnabledMark', title: '状态', width: 120,fixed: 'right', templet: function (d) {
                         if (d.F_EnabledMark == true) {
                             ...
                             return ""<span class='layui-btn layui-b");
            WriteLiteral(@"tn-warm layui-btn-xs'>未发布</span>"";
                         }
                     }
                 }
             ]]
         ...
         //toolbar监听事件
         table.on('too");
            WriteLiteral(@"lbar(currentTableFilter)', function (obj) {
             if (obj.event === 'add') {  // 监听添加操作
                 ...
                 common.openNewTabByIframe({
                     ...
                     href: """);
#nullable restore
#line 160 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
                        Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Content/"" + fileContentArr[0].code + ""?event=add&itemId="" + fileContentArr[0].nodeId
                 });
             }
                 ...
                 common.deleteForm({
                     url: """);
#nullable restore
#line 174 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
                       Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Content/DeleteForm"",
            ...
            WriteLiteral(@"urn false;
                 ...
                 common.openNewTabByIframe({
                  title: ""编辑内容"",
                     href: """);
#nullable restore
#line 211 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
                        Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Content/"" + fileContentArr[0].code + ""?event=edit&itemId="" + fileContentArr[0].nodeId + ""&keyValue="" + entity[0].F_Id
               });
           }
                 ...
                 common.openNewTabByIframe({
                    title: ""栏目管理"",
                     href: """);
#nullable restore
#line 217 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
                        Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Channel/Index"",
                    checkOpen: false
                });
             }
                 ...
                 common.submitPost({
                     url: """);
#nullable restore
#line 236 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
                       Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Content/PublishForm"",
                     prompt:""确认发布吗？"",
                     param: { keyValue: ids.join(',') },
                     success: function () {
                         common.reload('data-search-btn');
            ...
            WriteLiteral("    url: \"");
#nullable restore
#line 260 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\ContentManage\Views\Content\Index.cshtml"
                       Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/ContentManage/Content/RecycleForm"",
                     prompt:""确认下架吗？"",
                     param: { keyValue: ids.join(',') },
                     success: function () {
                         common.reload('data-search-btn');
...
<div class=""");
            WriteLiteral(@"layui-fluid"" style=""padding:0 0px"">
    <div class=""layui-row layui-col-space5"">
        <div class=""layui-col-md3 layui-col-xs4"">
            ...
            BeginWriteAttribute("action", " action=\"", 15019, "\"", 15028, 0);
            EndWriteAttribute();
            WriteLiteral(">\r\n                        <div class=\"layui-form-item\">\r\n                            <div class=\"layui-inline\">\r\n                                <input type=\"text\" id=\"item_keyword\" name=\"item_keyword\" autocomplete=\"off\" class=\"layui-input\"");
            BeginWriteAttribute("placeholder", " placeholder=\"", 15270, "\"", 15284, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                            </div>
                            <div class=""layui-inline"">
...
");
            ...
            BeginWriteAttribute("action", " action=\"", 16097, "\"", 16106, 0);
            EndWriteAttribute();
            WriteLiteral(">\r\n                        <div class=\"layui-form-item\">\r\n                            <div class=\"layui-inline\">\r\n                                <input type=\"text\" id=\"txt_keyword\" name=\"txt_keyword\" autocomplete=\"off\" class=\"layui-input\"");
            BeginWriteAttribute("placeholder", " placeholder=\"", 16346, "\"", 16360, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                            </div>
                            <div class=""layui-inline"">
