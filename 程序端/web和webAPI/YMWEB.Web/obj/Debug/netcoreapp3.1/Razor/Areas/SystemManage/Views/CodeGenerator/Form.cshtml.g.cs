#pragma checksum "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8a796576c3d1256f993150dc4dae1269295ca45d"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_SystemManage_Views_CodeGenerator_Form), @"mvc.1.0.view", @"/Areas/SystemManage/Views/CodeGenerator/Form.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8a796576c3d1256f993150dc4dae1269295ca45d", @"/Areas/SystemManage/Views/CodeGenerator/Form.cshtml")]
    public class Areas_SystemManage_Views_CodeGenerator_Form : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8a796576c3d1256f993150dc4dae1269295ca45d4682", async() => {
            }
            );
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "8a796576c3d1256f993150dc4dae1269295ca45d5804", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "8a796576c3d1256f993150dc4dae1269295ca45d6918", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
        ...
        $("".droppable"").droppable({
            ...
            drop: function (event, ui) {
                ...
                if (!$(ui.draggable).hasClass(""dropped"")) {
                    ...
                    //");
            WriteLiteral(@"$('<p class=""tools col-sm-12 col-sm-offset-3""><a class=""edit-link"">编辑HTML<a></p>').appendTo($el)
                } else {
    ...
    layui.use(['element', 'table', 'form', 'step', 'common', 'dtree', 'laydate', 'commonTable', 'optimizeSelectOption'], function () {
        ...
        $(function () {
            ...
            $(""#OutputModule"").bindSelect({
                url: """);
#nullable restore
#line 82 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
...
#nullable restore
#line 86 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
                      Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);
       ...
       ");
        ...
        commonTable.rendertable({
            ...
            cols: [[
                ...
                { field: 'Remark', title: '字段名称', mi");
            WriteLiteral(@"nWidth: 200 },
            ]]
        });
        var entity;
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听操作
                common.modalOpen({
                    ...
                    url: """);
#nullable restore
#line 226 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
                      Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/SystemManage/CodeGenerator/RuleForm"",
                    width: ""400px"",
                    height: ""400px"",
                });
            }
            ...
            WriteLiteral(@"  }
                ...
                common.modalOpen({
        ");
            WriteLiteral("            title: \"编辑字段\",\r\n                    url: \"");
#nullable restore
#line 275 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
                      Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);
...
#nullable disable
        ...
        form.on('submit(formStep2)', function (data) {
            if (outputOptions.getValue('value').length == 0) {
                o");
            WriteLiteral(@"utputOptions.warning();
                return false;
            }
            ...
            var treelist = [];
            for (");
            WriteLiteral(@"var i = 0; i < cachedata.length; i++) {
                var temp = {};
                var treetemp = {};
       ...
       ");
                            ...
                            if ($(divId).length == 0) {
                                ...
                                if (parseInt($(""#n_columns"").val()) == 1) {
                                    ...
                                    if (firstColumnInput > secondColumnInput) {
                                        t");
            WriteLiteral(@"arget = $("".layui-card-body .layui-col-md6"").last();
                                    }
                                    else {
            ...
            dtree.on(""node('formColumnList')"", function (obj) {
                ...
                if (obj.param.checked == ""0"") {
                    if ($(divId).length == 0) {
                        ...
                        if (parseInt($(""#n_columns"").val()) == 1) {
            ");
            WriteLiteral(@"                target = $("".layui-card-body .layui-col-md12"");
                        }
                        else {
                            var firstColumnInput = $("".layui-card-body .layui-col-md6"").first().find(""input"").length;
                            var secondColumnInput = $("".layui-card-body .layui-col-md6"").last().find(""input"").length;
                        ...
                        html = html.replace(/fieldName/g, ""fieldName"" + cout);
                        html = html.replace(/fieldCo");
            WriteLiteral(@"de/g, id); // 替换多个
                        html = html.replace(""divInputTemplate"", ""div"" + id);
                        var obj = $(html);
                        obj.removeAttr(""style"");
                        obj.appendTo(target);
        ...
        form.on('submit(formStep3)', function (data) {
            ...
            $.ajax({
                url: """);
#nullable restore
#line 501 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
                  Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/SystemManage/CodeGenerator/CodePreviewJson"",
                type: ""post"",
                dataType: 'json',
                async: false,
                data: baseConfig,
     ...
     ");
        ...
        form.on('submit(formStep4)', function (data) {
            ...
            common.submitForm({
                url: """);
#nullable restore
#line 537 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
                  Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/SystemManage/CodeGenerator/CodeGenerateJson"",
                param: postData,
                success: function () {
                }
            })
    ...
    function editName(data) {
        ...
        layui.use(['jquery', 'form', 'laydate', 'common'], function () {
            layui.common.modalOpen({
                ...
                url: """);
#nullable restore
#line 555 "E:\work\y疫苗小程序\发送源码\YMWEB.Web\Areas\SystemManage\Views\CodeGenerator\Form.cshtml"
                  Write(YMWeb.Code.GlobalContext.SystemConfig.VirtualDirectory);

#line default
#line hidden
#nullable disable
            WriteLiteral(@"/SystemManage/CodeGenerator/AddForm?parentform="" + window.name + ""&event="" + data,
                width: ""400px"",
                height: ""400px"",
    ...
    <div class=""layuimini-main"">
        <div class=""layui-carousel"" id=""stepForm"" lay-filter=""stepForm"">
                        ...
                        <div class=""layui-form-item"">
                            ...
                            <div class=""layui-input-block"">
                                <select id=""OutputModule"" name=""OutputModule"" lay-filter=""OutputModule"" lay-verify=""required"" lay-search>
                                    <option");
            BeginWriteAttribute("value", " value=\"", 26178, "\"", 26186, 0);
            EndWriteAttribute();
            WriteLiteral(@">请选择</option>
                     ...
                     ");
            WriteLiteral(@"   <div class=""form-group-bottom text-right"">
                            <div class=""layui-input-block"">
            ...
            WriteLiteral(@"                        <div class=""form-group-bottom text-right"">
                    ...
                    <script type=""text/html"" id=""toolbarDemo"">
                        <div class=""layui-btn-container"" id=""toolbar"">
                            ...
                            <button class=""layui-btn layui-btn-sm layui-btn-danger data-delete-btn"" lay-event=""delete""> <i class=""layui-icon"">&#x");
            WriteLiteral(@"e640;</i>删除</button>
                        </div>
                    </script>
                    ...
                    <form class=""layui-form layuimini-form "">
                        <div class=""layui-fluid"" style=""padding:0 0px"">
                            <div class=""layui-row layui-col-space5"">
                                ...
                                <div class=""layui-card lay");
            WriteLiteral(@"ui-col-md9 layui-col-xs8"">
                                    ...
                                    <div class=""layui-card-body"" id=""divForm"">
                                        <div id=""divInputTemplate"" class=""layui-form-item draggable ui-draggable dropped"" style=""display:none"">
                                            <label class=""layui-form-label"" id=""fieldName"">FieldName");
            WriteLiteral(@"</label>
                                        ...
                                        <div class=""layui-col-md6 layui-col-xs6 droppable sortable"" style=""displ");
            ...
            ");
            WriteLiteral(@"                    <div class=""layui-tab-item"" id=""codeDetails"" col=""CodeDetails"">
                                </div>
