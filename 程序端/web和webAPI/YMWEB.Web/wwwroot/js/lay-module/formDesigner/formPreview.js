        ...
        Class.prototype.components = {
            ...
            image: {
                ...
                render: function (json, selected) {
                    ...
                    _html += '<div class="file-iteme"><img class="layui-upload-img" src="{0}"><div class="info"></div>{1}</div>'.format(json.defaultValue ? document.location.origin + "/" + document.location.href.split("/")[3] + "/file/" + json.defaultValue : "", json.defaultValue ? json.defaultValue:"");
                    ...
                    var uploadInst = upload.render({
                        ...
                        , done: function (res) {
                            ...
                            $('#uploader-list-' + item.id).html(
                                '<div class="file-iteme">' +
                                //'<div class="handle"><i class="layui-icon layui-icon-delete"></i></div>' +
                                '<img class="layui-upload-img" src=' + document.location.origin + "/" + document.location.href.split("/")[3]+ "/file/" + res.data.src + '>' +
