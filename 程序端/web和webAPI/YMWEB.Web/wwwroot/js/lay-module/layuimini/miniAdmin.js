...
layui.define(["jquery", "miniMenu", "element", "miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        renderLogo: function (data) {
            //var html = '<a href="' + data.href + '"><img style="display:none" src="' + data.image + '" alt="logo"><h1>' + data.title + '</h1></a>';
        ...
        */
        ...
        listen: function () {
                        ...
                        if (data.code != 1) {
                            ...
                            var setTime1 = setTimeout(function () {
                                ...
                                if (document.location.href.split("/")[3] == "Home") {
                                    ...
                                    window.location.href = document.location.origin + "/" + document.location.href.split("/")[3] + '/Login/Index';
                                }
            ...
            $('body').on('click', '[data-notice]', function () {
                ...
                var contenthtml =""
                if (document.location.href.split("/")[3] == "Home") {
                    contenthtml = '/Home/Message';
                }
                else {
                    contenthtml = "/" + document.location.href.split("/")[3] + '/Home/Message';
                }
                layer.open({
                    type: 2,
                    title: false,
