...
//			level: "level",			  //层级
    ...
    DTree.prototype.loadTree = function(listData, level, $ul){
        ...
        if (listData) {
            ...
            for (var i = 0; i < listData.length; i++) {	// 遍历跟节点或追加的跟节点
                ...
                $ul.append(_this.getLiItemDom(parseData.treeId(), parseData.code(), parseData.parentId(), parseData.title(), parseData.fmtTitle(), parseData.last(children.length), parseData.ficonClass(), parseData.iconClass(), parseData.checkArr(), level, parseData.spread(level), parseData.disabled(), parseData.hide(), parseData.basicData(), parseData.recordData(), ($ul.hasClass(UL_ROOT) ? "root" : "item")));
    ...
    DTree.prototype.parseData = function(data) {
        ...
        return {
            ...
            code: function () {
                return data[_this.response.code];
            },
            parentId: function(){
     ...
     * @Param: hide： 是否隐藏
     */
    DTree.prototype.getDom = function(treeId,code, parentId, title, fmtTitle, last, ficonClass, iconClass, checkArr, level, spread, disabled, hide) {
        var _this = this,
            rootId = _this.obj[0].id,
        ...
        return {
            fnode: function() {	// + - 图标
                ...
                if(fnodeIcon != "-1" && fleafIcon != "-1"){	// 都加载
                    return last ? "<i class='" + fleafIconLeaf + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"'></i>" :
                        (spread ? "<i class='" + fnodeIconOpen + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "'></i>" : "<i class='" + fnodeIconClose + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+ficonClass+"'></i>");
                }

                if(fnodeIcon != "-1" && fleafIcon == "-1"){	// 加载node 隐藏leaf
                    return last ? "<i class='" + fleafIconLeaf + " " + ICON_HIDE + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"'></i>" :
                        (spread ? "<i class='" + fnodeIconOpen + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "'></i>" : "<i class='" + fnodeIconClose + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+ficonClass+"'></i>");
                }
                ...
                if(fnodeIcon == "-1" && fleafIcon == "-1"){	// 都隐藏
                    return last ? "<i class='" + fleafIconLeaf + " " + ICON_HIDE + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' style='display:none;'></i>" :
                        (spread ? "<i class='" + fnodeIconOpen + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "'></i>" : "<i class='" + fnodeIconClose + " " + _this.style.dfont + " " + _this.style.ficon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+ficonClass+"'></i>");
                }
            },
            node: function() {	// 二级图标样式
                ...
                if(nodeIcon != "-1" && leafIcon != "-1"){	// 都加载
                    return last ? "<i class='" + sleafIconLeaf + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>" :
                        (spread ? "<i class='" + snodeIconOpen + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "' data-iconClass='" + iconClass + "'></i>" : "<i class='" + snodeIconClose + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>");
                }
            ...
            checkbox: function() {	// 复选框
                ...
                if(flag){
                    var result = "<div class='" + LI_DIV_CHECKBAR + "' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"'>";
                    if(checkArr && checkArr.length > 0){
                        ...
                        for (var i = 0; i < checkArr.length; i++) {
                            ...
                            result += "<i class='" + CHOOSE_CLASS + " " + _this.style.dfont + " " + _this.style.cbox + " " + disClass + "' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-checked='"+checked+"' data-initchecked='"+checked+"' data-type='"+type+"' dtree-click='"+eventName.checkNodeClick+"' data-par='."+LI_CLICK_CHECKBAR+"' dtree-disabled='"+disabled+"'></i>";
                        }
                    }
                    result += "</div>";
                    return result;
            ...
            text: function() {	// 文字显示
                var disClass = "";
                if(disabled){disClass = NAV_DIS;}
                return "<cite class='" + LI_DIV_TEXT_CLASS + " " + disClass + "' data-id='" + treeId + "' data-leaf='" + (last ? "leaf" : "node") + "' dtree-disabled='" + disabled + "' data-code='" + code + "' data-title='" + title +"' >"+fmtTitle+"</cite>";
            },
            ul: function() {	//子节点ul
                return last ? "<ul class='"+LI_NAV_CHILD+"' data-id='"+treeId+"' dtree-id='"+rootId+"'></ul>" :
                    (spread ? "<ul class='" + LI_NAV_CHILD + " " + NAV_SHOW + "' data-id='" + treeId + "' dtree-id='" + rootId + "'></ul>" : "<ul class='" + LI_NAV_CHILD + "' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"'></ul>");
            }
        };
    };
     ...
     * @Param: hide： 是否隐藏
     */
    DTree.prototype.replaceDom = function ($div, treeId, code, last, spread, disabled, hide) {
        var _this = this,
            rootId = _this.obj[0].id,
            toolbar = _this.toolbar,
            checkbar = _this.checkbar;
        ...
        return {
            fnode: function(ficonClass) {	// + - 图标
                ...
                if(fnodeIcon != "-1" && leafIcon != "-1"){	// 都加载
                    fnode = last ? "<i class='" + fleafIconLeaf + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>" :
                        (spread ? "<i class='" + fnodeIconOpen + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "' data-iconClass='" + iconClass + "'></i>" : "<i class='" + fnodeIconClose + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+ficonClass+"'></i>");
            ...
            node: function(iconClass) {	// 二级图标样式
                ...
                if(nodeIcon != "-1" && leafIcon != "-1"){	// 都加载
                    snode = last ? "<i class='" + sleafIconLeaf + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>" :
                        (spread ? "<i class='" + snodeIconOpen + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "' data-iconClass='" + iconClass + "'></i>" : "<i class='" + snodeIconClose + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>");
                }else if(nodeIcon != "-1" && leafIcon == "-1"){	// 加载node 隐藏leaf
                    snode = last ? "<i class='" + sleafIconLeaf + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='last' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>" :
                        (spread ? "<i class='" + snodeIconOpen + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='open' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "' data-iconClass='" + iconClass + "'></i>" : "<i class='" + snodeIconClose + " " + DTREEFONTSPECIAL + " " + _this.style.dfont + " " + _this.style.icon + "' data-spread='close' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' data-iconClass='"+iconClass+"'></i>");
            ...
            ul: function() {	//子节点ul
                var ul = last ? "<ul class='" + LI_NAV_CHILD + "' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"'></ul>" :
                    (spread ? "<ul class='" + LI_NAV_CHILD + " " + NAV_SHOW + "' data-id='" + treeId + "' data-code='" + code + "' dtree-id='" + rootId + "'></ul>" : "<ul class='" + LI_NAV_CHILD + "' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"'></ul>");
     ...
     */
    DTree.prototype.getLiItemDom =  function(treeId,code, parentId, title, fmtTitle, last, ficonClass, iconClass, checkArr, level, spread, disabled, hide, basicData, recordData, isRoot) {
        var _this = this,
            rootId = _this.obj[0].id;

        var dom = _this.getDom(treeId, code, parentId, title, fmtTitle, last, ficonClass, iconClass, checkArr, level, spread, disabled, hide);
        basicData = (basicData == "{}") ? "" : basicData;
        recordData = (recordData == "{}") ? "" : recordData;
        var div = "<div class='" + LI_DIV_ITEM + " " + _this.style.item + "' data-id='" + treeId + "' data-code='" + code +"' dtree-id='"+rootId+"' dtree-click='"+eventName.itemNodeClick+"' data-basic='"+basicData+"' data-record='"+recordData+"' dtree-disabled='"+disabled+"' dtree-hide='"+hide+"' ";
        if(_this.toolbar){
        ...
        if(data) {
            if(data.length && data.length > 0) {
                ...
                if(parseData.treeId()){
                    ...
                    $ul.append(_this.getLiItemDom(parseData.treeId(), parseData.code(), parseData.parentId(), parseData.title(), parseData.fmtTitle(), parseData.last(0), parseData.ficonClass(), parseData.iconClass(), parseData.checkArr(), level, parseData.spread(), parseData.disabled(), parseData.hide(), parseData.basicData(), parseData.recordData(), "item"));
    ...
    DTree.prototype.partialRefreshEdit = function($div, data){
        ...
        if(data) {
            if(typeof data === 'object') {
                ...
                if(parseData.treeId()){
                    var replaceDom = _this.replaceDom($div, parseData.treeId(), parseData.code(),parseData.last(0), parseData.spread(), parseData.disabled(), parseData.hide());
                    replaceDom.div();
    ...
    DTree.prototype.getCheckbarNodeParam = function($div, $i){
        ...
        temp_node.code = $div.attr("data-code");
    ...
    DTree.prototype.getCheckbarJsonArrParam = function(){
    	...
    	if(params && params.length > 0) {
    		for(var i=0; i<params.length; i++) { 
                ...
                checkbarJsonArr["code"].push(param["code"]);
    ...
    DTree.prototype.setNodeParam = function($div) {
        ...
        _this.node.code = _this.getNodeDom($div).cite().attr("data-code");
    ...
    DTree.prototype.getTempNodeParam = function($div) {
        ...
        var temp_node = {};
        temp_node.nodeId = $div.attr("data-id");
        temp_node.code = _this.getNodeDom($div).cite().attr("data-code");
        temp_node.parentId = _this.getNodeDom($div).parentLi().attr("data-pid");
        temp_node.context = (typeof _this.formatter.title === 'function') ? _this.getNodeDom($div).cite().attr("data-title") : _this.getNodeDom($div).cite().text();
        temp_node.leaf = _this.getNodeDom($div).cite().attr("data-leaf") == "leaf" ? true : false;
        temp_node.level = _this.getNodeDom($div).parentLi().attr("data-index");
