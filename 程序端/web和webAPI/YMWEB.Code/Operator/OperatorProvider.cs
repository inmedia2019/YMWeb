...
namespace YMWeb.Code
{
    public class OperatorProvider
    {
        ...
        //YMWeb_operator_pc_ PC端登录
        //YMWeb_operator_info_ 登录次数
        //
        /// <summary>
        /// 缓存操作类
        /// </summary>
        private string cacheKeyOperator = "YMWeb_operator_";// +登录者token
        private string cacheKeyToken = "YMWeb_token_";// +登录者token
        private string cacheKeyError = "YMWeb_error_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "YMWeb_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "YMWeb_Mark";
